<%@ Page Language="vb" AutoEventWireup="false" CodeBehind="RestackPallets.aspx.vb" Inherits="DiversifiedLogistics.RestackPallets" %>

<!DOCTYPE html PUBLIC "-//W3C//DTD XHTML 1.0 Transitional//EN" "http://www.w3.org/TR/xhtml1/DTD/xhtml1-transitional.dtd">

<html xmlns="http://www.w3.org/1999/xhtml">
<head id="Head1" runat="server">
    <title>Restack Pallets</title>
    <style type="text/css">
        .lilBlueButton{
            font-size:11px;
            font-weight:bold;
...
<body id="theBody" runat="server">
    ...
    <table align="center">
        <tr>
            <td>
    <span class="headTitle">ReStack Pallets Report</span>
            </td>
        </tr>
        <tr>
            <td>
...
<td style="padding-left:25px;font-weight:normal;"><asp:LinkButton ID="lbReportView" runat="server" Text="Report View" /></td>
        <td align="right" style="padding-left:25px;" valign="middle">
...
<table cellpadding="0" cellspacing="0">
    <tr>
        <td>
<telerik:RadGrid ID="RadGrid1" runat="server" Width="825px" GridLines= "None" AutoGenerateColumns="False"
    AllowSorting="True" AllowFilteringByColumn="True" ShowGroupPanel="True" Skin="WebBlue">
    <ExportSettings FileName="ReStackPalletsReport" />
...
<MasterTableView CssClass="wdBack"  DataKeyNames="" GridLines="None" CommandItemDisplay="None">
    <Columns>
        ...
        <telerik:GridBoundColumn allowsorting="false" UniqueName="RestackPallets" HeaderText="Restack Pallets" 
            DataField="RestackPallets" DataFormatString="{0:N0}" visible="true" Groupable="false" AllowFiltering="false">
