...
Public Class RestackPallets
    ...
    Private Sub RadGrid1_NeedDataSource(ByVal sender As Object, ByVal e As Telerik.Web.UI.GridNeedDataSourceEventArgs) Handles RadGrid1.NeedDataSource
        ...
        If cbLocations.SelectedIndex > -1 Then
            ...
            dba.CommandText = "SELECT Location.Name AS Location, WorkOrder.LogDate [Date], Vendor.Name AS [CustomerId], " & _
                "WorkOrder.PurchaseOrder AS [PO], WorkOrder.Restacks AS [RestackPallets], Carrier.Name AS Carrier " & _
