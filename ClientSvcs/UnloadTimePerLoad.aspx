<%@ Page Language="vb" AutoEventWireup="false" CodeBehind="UnloadTimePerLoad.aspx.vb" Inherits="DiversifiedLogistics.UnloadTimePerLoad" %>

<!DOCTYPE html PUBLIC "-//W3C//DTD XHTML 1.0 Transitional//EN" "http://www.w3.org/TR/xhtml1/DTD/xhtml1-transitional.dtd">

<html xmlns="http://www.w3.org/1999/xhtml">
<head id="Head1" runat="server">
    <title>Unload Timer per Load Report</title>
    <style type="text/css">
        .lilBlueButton{
            font-size:11px;
            font-weight:bold;
...
<body id="theBody" runat="server">
    ...
    <table align="center">
        <tr>
            <td>
    <span class="headTitle">Unload Time per Load Report</span>
            </td>
        </tr>
        <tr>
            <td>
...
<table cellpadding="0" cellspacing="0">
    <tr>
        <td>
<telerik:RadGrid ID="RadGrid1" runat="server" Width="575px" GridLines= "None" AutoGenerateColumns="False"
    AllowSorting="True" AllowFilteringByColumn="True" ShowGroupPanel="True" Skin="WebBlue">
    <ExportSettings FileName="UnloadTimePerLoad" />
...
<MasterTableView CssClass="wdBack"  DataKeyNames="" GridLines="None">
    <Columns>
        <telerik:GridBoundColumn allowsorting="true" UniqueName="Name" HeaderText="Name" 
            DataField="Name" visible="true" Groupable="true" AllowFiltering="true">
        ...
        <telerik:GridBoundColumn allowsorting="false" UniqueName="Time" HeaderText="Time" 
            DataField="Time" visible="true" Groupable="false" AllowFiltering="false">
