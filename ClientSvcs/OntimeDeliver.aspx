<%@ Page Language="vb" AutoEventWireup="false" CodeBehind="OntimeDeliver.aspx.vb" Inherits="DiversifiedLogistics.OntimeDeliver" %>

<!DOCTYPE html PUBLIC "-//W3C//DTD XHTML 1.0 Transitional//EN" "http://www.w3.org/TR/xhtml1/DTD/xhtml1-transitional.dtd">

<html xmlns="http://www.w3.org/1999/xhtml">
<head id="Head1" runat="server">
    <title>On-Time Delivery Report</title>
    <style type="text/css">
        .lilBlueButton{
            font-size:11px;
            font-weight:bold;
...
<body id="theBody" runat="server">
    ...
    <table align="center">
        <tr>
            <td>
    <span class="headTitle">On-Time Delivery Report</span>
            </td>
        </tr>
        <tr>
            <td>
...
<table cellpadding="0" cellspacing="0">
    <tr>
        <td>
<telerik:RadGrid ID="RadGrid1" runat="server" Width="785px" GridLines= "None" AutoGenerateColumns="False"
    AllowSorting="True" AllowFilteringByColumn="True" ShowGroupPanel="True" Skin="WebBlue">
    <ExportSettings FileName="OnTimeDeliveryReport" />
...
<MasterTableView CssClass="wdBack"  DataKeyNames="" GridLines="None" CommandItemDisplay="None">
    <Columns>
        <telerik:GridBoundColumn allowsorting="false" UniqueName="Location" HeaderText="Location" 
            DataField="Location" visible="false" Groupable="false" AllowFiltering="false">
        ...
        <telerik:GridBoundColumn allowsorting="true" UniqueName="PO" HeaderText="PO #" 
            DataField="PONumber" visible="true" Groupable="false" AllowFiltering="true">
            <HeaderStyle Width="110" />
        </telerik:GridBoundColumn>
        ...
        <telerik:GridBoundColumn allowsorting="false" UniqueName="AppointmentTime" HeaderText="Appointment" 
            DataField="AppointmentTime" DataFormatString="{0:hh:mm tt}" visible="true" Groupable="false" AllowFiltering="false">
            <HeaderStyle Width="85" />
        </telerik:GridBoundColumn>
        <telerik:GridBoundColumn allowsorting="false" UniqueName="OnTime" HeaderText="OnTime" 
            DataField="OnTime" visible="true" Groupable="false" AllowFiltering="false">
            <HeaderStyle Width="85" />
        </telerik:GridBoundColumn>
    </Columns>
</MasterTableView>
