<%@ Page Language="vb" AutoEventWireup="false" CodeBehind="LoadsSummary.aspx.vb" Inherits="DiversifiedLogistics.LoadsSummary" %>

<!DOCTYPE html PUBLIC "-//W3C//DTD XHTML 1.0 Transitional//EN" "http://www.w3.org/TR/xhtml1/DTD/xhtml1-transitional.dtd">

<html xmlns="http://www.w3.org/1999/xhtml">
<head id="Head1" runat="server">
    <title>Load Summary Report</title>
    <style type="text/css">
        .lilBlueButton{
            font-size:11px;
            font-weight:bold;
...
<body id="theBody" runat="server">
    ...
    <table align="center">
        <tr>
            <td>
    <span class="headTitle">Load Summary Report</span>
            </td>
        </tr>
        <tr>
            <td>
...
<telerik:RadGrid ID="RadGrid1" runat="server" Width="1024px" GridLines= "None" AutoGenerateColumns="False"
    ...
    <ExportSettings FileName="LoadSummaryReport" />
...
<MasterTableView CssClass="wdBack"  DataKeyNames="" GridLines="None" CommandItemDisplay="None">
    <Columns>
        ...
        <telerik:GridBoundColumn AllowSorting="true" UniqueName="Date" HeaderText="Date" 
            DataField="Date" DataFormatString="{0:MM/dd/yyyy}" visible="true" Groupable="false" AllowFiltering="false">
        ...
        <telerik:GridBoundColumn AllowSorting="true" UniqueName="PONum" HeaderText="PO Num" 
            DataField="PONum" visible="true" Groupable="false" AllowFiltering="true">
            <HeaderStyle Width="115" />
        </telerik:GridBoundColumn>
        ...
        <telerik:GridBoundColumn AllowSorting="false" UniqueName="Trailer" HeaderText="Trailer" 
            DataField="Trailer" visible="true" Groupable="true" AllowFiltering="true">
            <HeaderStyle Width="115" />
        </telerik:GridBoundColumn>
        ...
        <telerik:GridBoundColumn AllowSorting="true" UniqueName="Customer" HeaderText="Customer" 
            DataField="Customer" visible="true" Groupable="true" AllowFiltering="true">
            <HeaderStyle Width="225" />
        </telerik:GridBoundColumn>
        <telerik:GridBoundColumn AllowSorting="false" UniqueName="Weight" HeaderText="Weight" 
            DataField="Weight" DataFormatString="{0:#,#}" visible="true" Groupable="false" AllowFiltering="false">
            <HeaderStyle Width="65" />
        </telerik:GridBoundColumn>
        ...
        <telerik:GridBoundColumn AllowSorting="false" UniqueName="Amount" HeaderText="Amount" 
