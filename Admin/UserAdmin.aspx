<%@ Page Language="vb" AutoEventWireup="false" CodeBehind="UserAdmin.aspx.vb" Inherits="DiversifiedLogistics.UserAdmin" %>
...
<table>
	<tr>
		<td  valign="top">  <%-- left side user grid and filter--%>
		<div style="margin:0px 20px;">
            ...
            <asp:ListItem Text="SysOp" />
            <asp:ListItem Text="Administrator" />
            <asp:ListItem Text="Manager" />
            <asp:ListItem Text="Supervisor" />
            <asp:ListItem Text="Clerk" />
            <asp:ListItem Text="Employee" />
            </asp:RadioButtonList>
        <table width="100%">
            <tr>
                <td><span id="GridInstructions" style="font-size:11px;" runat="server">Click user name to edit and/or remove lockout</span></td>
                <td><telerik:RadTextBox ID="txtFilter" runat="server" /></td>
...
<MasterTableView DataKeyNames="userName" Width ="415px">
...
<table>
    <tr>
        <td>Allowed Locations<br />
            <telerik:RadListBox ID="lbLocationList" TransferMode="Move" AllowTransfer="true" 
                TransferToID="lbAvailableLocations" runat="server" DataKeyField="ID"
                EmptyMessage="None listed, move locations from restricted list  ->>"  
                Width="175px" Height="150px" AllowDelete="false" ButtonSettings-ShowTransferAll="True" 
                ButtonSettings-ShowReorder="True" AllowReorder="True" EnableDragAndDrop="True"
                ButtonSettings-ShowDelete="False" >
           </telerik:RadListBox>
        </td>
        <td>Restricted Locations<br />
            <telerik:RadListBox ID="lbAvailableLocations" runat="server" DataKeyField="ID" AllowTransfer="True"
