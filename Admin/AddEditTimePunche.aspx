...
<%--            *********************** Data columns--%>
            ...
            <telerik:GridTemplateColumn DataField="JobDescription" DataType="System.String"
                ...
                <EditItemTemplate>
                    <telerik:RadCombobox runat="server" ID="cbJobDescription" EmptyMessage="Select JobDescription" />
            ...
            <telerik:GridBoundColumn DataField="JobDescriptionID" DataType="System.Guid" visible="false"
                UniqueName="JobDescriptionID" ReadOnly="True">
            </telerik:GridBoundColumn> 
